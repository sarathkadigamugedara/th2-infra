...
| infraEditor.image.tag | string | `"1.0.65-TH2-3209-2226517175"` |  |
| infraEditorV2.enabled | bool | `true` |  |
| infraEditorV2.image.repository | string | `"ghcr.io/th2-net/th2-infra-editor-v2"` |  |
| infraEditorV2.image.tag | string | `"2.0.15-TH2-3209-2183869724"` |  |
...
| infraMgr.image.tag | string | `"1.7.19"` |  |
...
| infraOperator.image.tag | string | `"3.6.4"` |  |
...
| infraRepo.image.tag | string | `"1.8.0-drop-2"` |  |
